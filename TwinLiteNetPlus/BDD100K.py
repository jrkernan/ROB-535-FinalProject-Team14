...
class DatasetOneTask(torch.utils.data.Dataset):
    ...
    def __init__(self, hyp, valid=False, transform = None,task = None):
        ...
        self.valid=valid
        if valid:
            self.root='/scratch/rob535f25s001_class_root/rob535f25s001_class/jrkernan/bdd100k/images/val'
            self.names=os.listdir(self.root)
        else:
            self.root='/scratch/rob535f25s001_class_root/rob535f25s001_class/jrkernan/bdd100k/images/train'
            self.names=os.listdir(self.root)
